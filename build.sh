...
ANYKERNEL_DIR="$HOME/bomb/AnyKernel3/r8qLOS"
...
rm -rf .version .local
make O="$OUT_DIR" $HOST_BUILD_ENV vendor/kona-perf_defconfig vendor/samsung/kona-sec-common.config vendor/samsung/r8q.config
